...
// XKKeychain
#define COCOAPODS_POD_AVAILABLE_XKKeychain
#define COCOAPODS_VERSION_MAJOR_XKKeychain 0
#define COCOAPODS_VERSION_MINOR_XKKeychain 1
#define COCOAPODS_VERSION_PATCH_XKKeychain 0
